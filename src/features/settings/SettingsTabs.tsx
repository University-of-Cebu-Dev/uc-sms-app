...
import { ClipboardList, GraduationCap, Palette } from 'lucide-react'
...
export function SettingsTabs() {
  return (
    <div className="border-t border-gh-border bg-gh-canvas-subtle/50 px-4 py-2 flex justify-center">
      <nav
