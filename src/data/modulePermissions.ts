...
export const portalModules: PortalModule[] = [
  ...
  },
  {
    id: 'records',
    label: 'Records',
    description: 'Student and parent person records.',
    icon: Contact,
    path: '/records',
    accessPermission: 'UCSMS.Records.Access',
    group: 'core',
  },
  {
    id: 'records-settings',
    label: 'Records Settings',
    description: 'Manage the lookup tables behind person records.',
    icon: ListTree,
    path: '/records/settings',
    accessPermission: 'UCSMS.PersonLookups.Manage',
    group: 'core',
  },
  {
    id: 'schedules',
